...
const SPRINT_ONE_QA_HOST = 'black-oracle-git-sprint-1-op-262094-kimwriter222-7385s-projects.vercel.app';
...
const AppContent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const qaHost = window.location.hostname.toLowerCase() === SPRINT_ONE_QA_HOST;
